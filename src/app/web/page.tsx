...
.oriavision-web-exact .conv-cta-top { margin-top: 0; }
.oriavision-web-exact .conv-cta-action {
  display: flex;
  flex-direction: column;
  align-items: flex-end;
  gap: 8px;
...
.oriavision-web-exact .conv-cta-note {
  font-size: 12px;
  color: var(--muted);
  line-height: 1.45;
  font-weight: 500;
...
/* Banda navy con claims comerciales (reemplaza los números) */
.oriavision-web-exact .stat-claim { text-align: center; max-width: 300px; }
.oriavision-web-exact .stat-claim-title {
  display: block;
  font-family: 'Inter', system-ui, sans-serif;
...
.oriavision-web-exact .stat-claim small { margin-top: 10px; }
...
/* Banda navy: apilar los 3 claims en mobile para que no queden apretados */
@media (max-width: 900px) {
  .oriavision-web-exact .stats-band .stats-row { flex-direction: column; flex-wrap: wrap; gap: 22px; }
  .oriavision-web-exact .stats-band .stat-claim { max-width: 100%; }
  .oriavision-web-exact .stats-band .stat-divider { display: block; width: 60px; height: 1px; }
}
