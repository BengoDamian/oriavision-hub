...
const WEB_CSS_DESKTOP_QUIRVO_CARD_FIX_V36 = `
/* V36 /web desktop: Quirvo usa una miniatura dedicada casi cuadrada para que no se corte dentro de la card. No toca mobile. */
@media (min-width: 769px) {
  .oriavision-web-exact #portfolio .port-card img[alt='Quirvo'] {
    width: 100% !important;
    height: 100% !important;
  ...
  .oriavision-web-exact #portfolio .port-card:has(img[alt='Quirvo']) {
    background: #071B52 !important;
  }
}
`;
...
const WEB_CSS_MOBILE_QUIRVO_SIZE_FIX_V38 = `
/* V38: Quirvo en /web mobile mantiene exactamente el mismo rectángulo que las otras cards.
   Solo ajusta la imagen para que llene bien ese rectángulo, sin agrandar la card. */
@media (max-width: 768px) {
  .oriavision-web-exact #portfolio .port-card:has(img[alt='Quirvo']) picture {
    display: block !important;
    width: 100% !important;
    aspect-ratio: 16 / 9 !important;
    height: auto !important;
...
export default function WebPage() {
  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: WEB_CSS + WEB_PORTFOLIO_LINK_FIX_V20 + WEB_CSS_DESKTOP_QUIRVO_CARD_FIX_V36 + WEB_CSS_MOBILE_FIX + WEB_CSS_MOBILE_FIX_V3 + WEB_CSS_MOBILE_FIX_V4 + WEB_CSS_MOBILE_FIX_V6 + WEB_CSS_DESKTOP_OPTIONS_FIX_V7 + WEB_CSS_MOBILE_RECT_FIX_V9 + WEB_CSS_MOBILE_PORTFOLIO_FIT_V10 + WEB_CSS_MOBILE_PORTFOLIO_IMAGES_V11 + WEB_CSS_MOBILE_PORTFOLIO_IMAGES_V12 + WEB_CSS_MOBILE_PORTFOLIO_CENTER_V34 + WEB_CSS_MOBILE_PORTFOLIO_CONTAIN_V35 + WEB_CSS_MOBILE_QUIRVO_SIZE_FIX_V38 }} />
