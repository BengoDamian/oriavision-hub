...
/* Grilla de opciones a 2 columnas para las 4 opciones */
.oriavision-web-exact #opciones .svc-grid { grid-template-columns: repeat(2, 1fr); }

@media (max-width: 1024px) {
  .oriavision-web-exact #opciones .svc-grid { grid-template-columns: 1fr; }
}
