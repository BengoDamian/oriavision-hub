    ...
    <main className="min-h-screen bg-white">
      <div className="mx-auto max-w-xl px-5 py-16">
        <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm text-center">
          ...
          <p className="mt-3 text-textBody font-semibold">
          ...
          <div className="mt-8 grid gap-3">
            <a
              href="/go/calculadora"
              className="rounded-full bg-brand-600 hover:bg-brand-700 px-8 py-3 text-white font-extrabold transition-colors"
            >
            ...
            <div className="grid grid-cols-2 gap-3">
              <Link
                href="/prompts"
                className="rounded-full border-2 border-slate-200 px-6 py-3 font-extrabold text-slate-900 hover:border-brand-600 hover:text-brand-600 transition-colors"
              >
                Ver Prompts
              </Link>
              <Link
